    ...
    <el-container>
      <el-tabs v-model="activeTabName" type="card" style="width: 100%" @tab-click="handleTabClick">
        <el-tab-pane :label="$t('tab.registration.lable')" name="first">
          <el-form ref="ruleForm" :rules="rules" hide-required-asterisk label-width="120px">
            ...
            <div v-if="activeStep===0">
              ...
              <el-row>
                <el-col :span="6" :offset="20">
                  <el-button type="primary" @click="profileNextStep">{{$t("common.continue")}}</el-button>
                </el-col>
              </el-row>
            </div>
            <div v-if="activeStep===1">
              <div v-if="accessStep===1">
                ...
                <Authorization :authProp="this.$store.state.currUser.authorization"></Authorization>
                <el-row>
                  <el-col :span="6">
                    <el-button type="primary" @click="authPrevStep">{{$t("register.button.back")}}</el-button>
                  </el-col>
              ...
              <div v-if="accessStep===2">
                <!-- Attributes modula -->
                <Attributes :attrProp="this.$store.state.currUser.attributes"></Attributes>
                <el-row>
                  <el-col :span="6">
                    <el-button type="primary" @click="attrPrevStep">{{$t("register.button.back")}}</el-button>
                  </el-col>
                  <el-col :span="6" :offset="12">
                    <el-button
                      type="primary"
            ...
            <div v-if="activeStep===2">
              <div v-if="entStep===1">
                <Emaildomain :emdomainProp="this.$store.state.currUser.emaildomains"></Emaildomain>
                <el-row>
                  <el-col :span="6">
              ...
              <!-- entitlement module -->
              <div v-if="entStep===2">
                <Entitlement :entProp="this.$store.state.currUser.entitlement" :flag="errorFlag"></Entitlement>
                <el-row>
                  <el-col :span="6">
                    <el-button type="primary" @click="entPrevStep">{{$t("register.button.back")}}</el-button>
                  </el-col>
                  <el-col :span="6" :offset="12">
                    <el-button type="primary" @click="entNextStep">{{$t("common.continue")}}</el-button>
                  </el-col>
                </el-row>
              </div>
            </div>
            <div v-if="activeStep===3">
              ...
              <el-row>
                <el-col :span="6">
                  <el-button type="primary" @click="revPrevStep">{{$t("register.button.back")}}</el-button>
                </el-col>
                <el-col :span="6" :offset="12">
                  <el-button type="primary" @click="submitForm">{{$t("switchid.ci162.submit")}}</el-button>
                </el-col>
              </el-row>
            </div>
  ...
  methods: {
    ...
    async postRegister (bodyData) {
      ...
      const result = await post(
        `/user/update/${this.$store.state.currUser.iruser.ibmuniqueid}`,
        bodyData
      )
