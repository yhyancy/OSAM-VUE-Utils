      ...
      <el-tab-pane label="OSAM Registration" name="first">
        <el-form ref="formData" :model="formData" hide-required-asterisk label-width="120px">
          <el-steps :active="activeStep" finish-status="success" simple align-center>
            <el-step title="Verify profile"></el-step>
            <el-step title="Request access"></el-step>
            <el-step title="Provide entitlement"></el-step>
          ...
          <div v-show="activeStep===0">
            <el-row>
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ fullName }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.phone }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.email }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.company }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.street1 }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.city }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
                <div class="grid-content bg-purple">Postal Code:</div>
              </el-col>
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.zipcode }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.state }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ formData.iruser.country }}</div>
              </el-col>
            </el-row>
            <el-row>
          ...
          <div v-show="activeStep===2">
            ...
            <br />
            <!-- CSO center -->
            <el-form-item v-if="formData.authorization.roleid=== 20" label="CSO Center:">
              <el-select
                v-model="formData.attributes.csoid"
                clearable
          ...
          <div v-show="activeStep===3">
            ...
            <el-row>
              <el-col :span="24">
                <div class="grid-content bg-purple-dark">Profile information</div>
              </el-col>
            </el-row>
            <hr />
            <el-row>
            ...
            <el-row>
              <el-col :span="24">
                <div class="grid-content bg-purple-dark">Entitlement information</div>
              </el-col>
            </el-row>
            <hr />
            <el-row>
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ appDisplay }}</div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6">
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ roleDisplay }}</div>
              </el-col>
            </el-row>
            <el-row v-if="formData.attributes.csoid">
              <el-col :span="6">
                <div class="grid-content bg-purple">CSO Center:</div>
              </el-col>
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ csoDisplay }}</div>
              </el-col>
            </el-row>
            <el-row v-if="formData.attributes.hqcountry">
              <el-col :span="6">
                <div class="grid-content bg-purple">Your Country:</div>
              </el-col>
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ hqCtryDisplay }}</div>
              </el-col>
            </el-row>
            <br />
            <el-row>
          ...
          <div v-show="activeStep===4">
            ...
            <el-row>
              ...
              <el-col :span="18">
                <div class="grid-content bg-purple-light">{{ entitlementrequestid }}</div>
              </el-col>
            </el-row>
            <hr />
            <el-row>
            ...
            <div>
              Dear Valued Customer,<br><br>
                Thank you for registering for access to Order Status OnLine. We will now have your authorization request reviewed by an IBM/Lenovo Representative. This process should take no longer than two business days, and you will receive a confirmation e-mail.
              Please refer to Entitlement Request ID# <strong> {{ entitlementrequestid }} </strong> should you need to inquire about your request. Click on the Customer support link to the left to obtain contact information for your team.
...
export default {
  ...
  computed: {
    ...
    csoDisplay: function () {
      if (this.formData.attributes.csoid) {
        return this.getAppRoleLabel(
          this.formData.attributes.csoid,
          this.csoOptions
        )
      } else {
        return ''
  ...
  methods: {
    ...
    prevStep () {
      if (
        this.formData.authorization.roleid === 18 ||
        this.formData.authorization.roleid === 22
      ) {
    ...
    handleRoleChange (val) {
      ...
      if (val === 22) {
        this.formData.attributes.hqcountry = ''
      }
    ...
    getHqCountry () {
      ...
      // if select all countries, use 'World Wide' for the display
      if (
